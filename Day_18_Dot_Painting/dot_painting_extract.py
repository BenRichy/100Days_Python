import colorgram
colour_list = colorgram.extract('img/hirst_img.jpg', 30)
...
# paste out list of colours
# check which colours are similar to a background colour and remove these
# first 3 colours removed
